...
const ByEmail = () => {
  ...
  return (
    <Row className={styles.root} justify="center" align="middle" gutter={[0, 8]}>
      ...
      <Col span={24}>
        <Form layout="vertical" requiredMark={false} initialValues={{ remember: true }} autoComplete="off" onFinish={handleFinish}>
          <Form.Item
          ...
          <Form.Item>
            <Space size="large">
              ...
              <Typography.Link href="/activate">Еще не активировали контейнер?</Typography.Link>
            </Space>
          </Form.Item>
        </Form>
      </Col>
